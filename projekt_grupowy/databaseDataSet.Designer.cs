...
namespace projekt_grupowy {
    ...
    public partial class databaseDataSet : global::System.Data.DataSet {
        ...
        public partial class TableDataTable : global::System.Data.TypedTableBase<TableRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public TableRow AddTableRow(int CustomerID, string Name, string Surname, string Phone, string Brand, string Model) {
        ...
        public partial class TableRow : global::System.Data.DataRow {
            ...
            public string Brand {
                get {
                    try {
                        return ((string)(this[this.tableTable.BrandColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("The value for column \'Brand\' in table \'Table\' is DBNull.", e);
                    }
                }
                set {
                    this[this.tableTable.BrandColumn] = value;
                }
            }
            ...
            public bool IsBrandNull() {
                return this.IsNull(this.tableTable.BrandColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public void SetBrandNull() {
                this[this.tableTable.BrandColumn] = global::System.Convert.DBNull;
            }
...
namespace projekt_grupowy.databaseDataSetTableAdapters {
    ...
    public partial class TableTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Table] WHERE (([CustomerID] = @Original_CustomerID) AND ((@IsNull_Name = 1 AND [Name] IS NULL) OR ([Name] = @Original_Name)) AND ((@IsNull_Surname = 1 AND [Surname] IS NULL) OR ([Surname] = @Original_Surname)) AND ((@IsNull_Phone = 1 AND [Phone] IS NULL) OR ([Phone] = @Original_Phone)) AND ((@IsNull_Brand = 1 AND [Brand] IS NULL) OR ([Brand] = @Original_Brand)) AND ((@IsNull_Model = 1 AND [Model] IS NULL) OR ([Model] = @Original_Model)))";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Table] SET [CustomerID] = @CustomerID, [Name] = @Name, [Surname] = @Surname, [Phone] = @Phone, [Brand] = @Brand, [Model] = @Model WHERE (([CustomerID] = @Original_CustomerID) AND ((@IsNull_Name = 1 AND [Name] IS NULL) OR ([Name] = @Original_Name)) AND ((@IsNull_Surname = 1 AND [Surname] IS NULL) OR ([Surname] = @Original_Surname)) AND ((@IsNull_Phone = 1 AND [Phone] IS NULL) OR ([Phone] = @Original_Phone)) AND ((@IsNull_Brand = 1 AND [Brand] IS NULL) OR ([Brand] = @Original_Brand)) AND ((@IsNull_Model = 1 AND [Model] IS NULL) OR ([Model] = @Original_Model)));
SELECT CustomerID, Name, Surname, Phone, Brand, Model FROM [Table] WHERE (CustomerID = @CustomerID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::projekt_grupowy.Properties.Settings.Default.databaseConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT CustomerID, Name, Surname, Phone, Brand, Model FROM dbo.[Table]";
        ...
        public virtual int SearchSurname(databaseDataSet.TableDataTable dataTable, string Surname) {
        ...
        public virtual int Delete(int Original_CustomerID, string Original_Name, string Original_Surname, string Original_Phone, string Original_Brand, string Original_Model) {
        ...
        public virtual int Insert(int CustomerID, string Name, string Surname, string Phone, string Brand, string Model) {
        ...
        public virtual int Update(int CustomerID, string Name, string Surname, string Phone, string Brand, string Model, int Original_CustomerID, string Original_Name, string Original_Surname, string Original_Phone, string Original_Brand, string Original_Model) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Name, string Surname, string Phone, string Brand, string Model, int Original_CustomerID, string Original_Name, string Original_Surname, string Original_Phone, string Original_Brand, string Original_Model) {
            return this.Update(Original_CustomerID, Name, Surname, Phone, Brand, Model, Original_CustomerID, Original_Name, Original_Surname, Original_Phone, Original_Brand, Original_Model);
        }
    }
